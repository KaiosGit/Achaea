...
*Character Database (Character DB) for Nexus is required for a portion of this script to work correctly. It can be found here: https://forums.achaea.com/discussion/6527/character-db-nexus
